...
<?php ob_start(); /* cphTitle*/ ?>
	<form name="formCadastro" id="formCadastro" action="cadastro-acoes.php" method="post" enctype="multipart/form-data">
		...
		<div class="div-campos">
			<textarea class="form-control" id="descricao_titulo" name="descricao_titulo" rows="4" required placeholder="Descrição do Título" style="resize: none;"><?php echo $ocdCadastro->descricaoTitulo; ?></textarea>
		</div>
		<div class="div-campos">
